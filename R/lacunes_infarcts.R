...
#' @param missing The proportion of participants who did not receive an MRI
#' @param ids Optional vector of participant IDs
#' @param visit_ids Optional vector of visit IDs
#' @return A data.frame
#' @export
lacunes_infarcts <- function(n, visit = "V1", missing = 0.1, ids = NULL, visit_ids = NULL) {
